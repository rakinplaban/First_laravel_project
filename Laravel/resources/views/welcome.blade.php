            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link text text-light" aria-current="page" href="{% url 'index' %}">Home</a>
                  </li>
                  <!--
                  <li class="nav-item">
                    <a class="nav-link text text-light" href="{% url 'edit' %}">Add new</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text text-light" href="{% url 'jsonobject' %}">Json Object</a>
                  </li> -->
                </ul>
                <form class="d-flex">
